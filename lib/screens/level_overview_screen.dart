...
final levelDetailProvider = FutureProvider.autoDispose.family<Level, String>((
  ref,
  levelId,
) async {
      ...
      body: levelAsync.when(
        ...
        data: (level) {
          ...
          final String markdownData =
              level.contentMarkdown != null && level.contentMarkdown!.isNotEmpty
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton(
                              ...
                              onPressed: () =>
                                  context.push('/level/${level.id}/questions'),
