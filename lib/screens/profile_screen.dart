...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final fallbackName = authUser?.userMetadata?['full_name'] as String? ?? 'Agent';
    ...
    return Scaffold(
      ...
      body: profileAsync.when(
        ...
        data: (profile) {
          ...
          final double totalScore = double.tryParse(profile['total_score']?.toString() ?? '0') ?? 0.0;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    title.toUpperCase(), 
                    style: const TextStyle(color: Colors.purpleAccent, fontSize: 12, letterSpacing: 1.5, fontWeight: FontWeight.bold)
                  ),
                  ...
                  Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text('${totalScore.toInt()} XP', style: const TextStyle(color: Colors.purpleAccent, fontWeight: FontWeight.bold, fontSize: 12)),
                          Text('${xpNeeded.toInt()} XP to Next Tier', style: const TextStyle(color: Colors.white54, fontSize: 12)),
                        ],
                      ),
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            value: progressPercent == 0 && totalScore > 0 ? 1.0 : progressPercent,
                            backgroundColor: Colors.transparent,
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildGamifiedStatCard('Total XP', _formatXP(totalScore), Icons.star, Colors.amber)),
                      const SizedBox(width: 12),
                      Expanded(child: _buildGamifiedStatCard('Streak', '$streak Days', Icons.local_fire_department, Colors.deepOrange)),
                      const SizedBox(width: 12),
                      Expanded(child: _buildGamifiedStatCard('Certs', hasPassedFinal ? '1' : '0', Icons.workspace_premium, Colors.greenAccent)),
                    ],
                  ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text('SKILL BADGES', style: TextStyle(color: Colors.white54, fontSize: 12, letterSpacing: 1.5, fontWeight: FontWeight.bold)),
                      TextButton(
                        onPressed: () {}, 
                        child: const Text('View All', style: TextStyle(color: Colors.purpleAccent, fontSize: 12))
                      ),
                    ],
                  ),
                  const SizedBox(height: 8),
                    ...
                    data: (skills) {
                      ...
                      return GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final String skillTitle = skill['skill_title'] ?? skill['title'] ?? 'Skill';
                          ...
                          return _buildSkillBadgeCard(skillTitle, status, iconColor, Icons.architecture);
                        },
                      );
                    },
                  ),
  ...
  Widget _buildGamifiedStatCard(String label, String value, IconData icon, Color iconColor) {
    return Container(
  ...
  Widget _buildSkillBadgeCard(String title, String status, Color color, IconData icon) {
    return Container(
    ...
    return Container(
      ...
      child: const Column(
        children: [
          ...
          SizedBox(height: 12),
          Text('Complete assessments to unlock skill badges.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white54, fontSize: 12)),
        ],
      ),
    );
  }
        ...
        builder: (context, scrollController) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              _buildActionTile(Icons.track_changes, 'Change Primary Goal', () {
                Navigator.pop(context);
        ...
        child: Column(
          ...
          children: [
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Get notified to complete your daily training.', style: TextStyle(color: Colors.white54, fontSize: 12)),
              value: true,
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Alerts when your global percentile changes.', style: TextStyle(color: Colors.white54, fontSize: 12)),
              value: false,
              activeThumbColor: Colors.purpleAccent,
              onChanged: (val) {},
            ),
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            const Text('Need assistance with your certification prep?', style: TextStyle(color: Colors.white54, fontSize: 14)),
            const SizedBox(height: 24),
            ListTile(
